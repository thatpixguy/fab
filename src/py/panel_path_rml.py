   ...
   def __init__(self,parent):
      ...
      def make_rml(event):
         ...
         if (self.parent.zmin == ''):
            ...
            zmin = str(self.parent.zmin*self.parent.units)
         command = 'path_rml '+'\"'+self.parent.path_file+'\"'+' '+'\"'+self.parent.rml_file+'\"'+' '+speed+' '+xmin+' '+ymin+' '+zmin+' '+zjog
         print command
         os.system(command)
      ...
      row3_sizer.Add(wx.StaticText(row3_panel,label='speed (mm/s)'),(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      row3_sizer.Add(wx.StaticText(row3_panel,label='jog (mm)      '),(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
      ...
      self.speed = wx.TextCtrl(row4_panel,-1,'4')
      row4_sizer.Add(self.speed,(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      self.zjog = wx.TextCtrl(row4_panel,-1,'1')
      row4_sizer.Add(self.zjog,(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
      ...
      row5_sizer.Add(wx.StaticText(row5_panel,label='xmin (mm)'),(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      row5_sizer.Add(wx.StaticText(row5_panel,label='ymin (mm)'),(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
      ...
      self.xmin = wx.TextCtrl(row6_panel,-1,'20')
      row6_sizer.Add(self.xmin,(0,0),flag=wx.ALIGN_CENTER_HORIZONTAL)
      self.ymin = wx.TextCtrl(row6_panel,-1,'20')
      row6_sizer.Add(self.ymin,(0,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
      ...
      self.sizer.Add(move,(7,0),span=(1,2),flag=wx.ALIGN_CENTER_HORIZONTAL)
      #
      # fit
      #
      self.Fit()
